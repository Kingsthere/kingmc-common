...
/**
 * The API marked with this annotation is internal, and it is not intended to be used outside kingmc.
 */
@RequiresOptIn(
 ...
 * not be instantiated by anyone.
 * In kotlin, the classes that are annotated with this should be written as an
 * [object](https://kotlinlang.org/docs/object-declarations.html).
 * A utility class in kotlin should look like this:
 * ```
 * @Utility
 * class UtilityClass {
 *     // ...
 ...
 * ```
 *
 * In java classes the classes
 * annotated with this should have a [**private constructor**][java.lang.reflect.Constructor]
 ...
 * from **must be a singleton or object**, is equivalent to the subclasses
